...
const Search = () => {
  ...
  <div className='searchDiv grid gap-10 bg-greyIsh rounded-[10px] p-[3rem]'>
        ...
        <div className="firstDiv flex justify-between items-center rounded-[8px] gap-[10px]
         bg-white p-5 shadow-lg shadow-greyIsh-700 ">
          ...
          <div className="flex gap-2 items-center">
            ...
            <input id='text' type='text' className='bg-transparent text-blue-500 
            focus:outline-none w-[100%]' placeholder='Search by location...' />
            {/* <AiOutlineCloseCircle className='text-[30px] text-[#a5a6a6] hover:text-textColor icon'/> */}
          </div>
          <button className=' bg-resetColor h-full p-5 px-10 rounded-[10px] text-white 
          cursor-pointer hover:bg-gray-400'>Reset</button>
    ...
    <div className='secDiv flex items-center gap-10 justify-center'>
      ...
      <input className='bg-greyIsh cursor-pointer text-center' value={"Clear All"} type='reset' />
     </div>
  </div>
  )
}
